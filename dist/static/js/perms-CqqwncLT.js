    ...
    setup(D) {
      ...
      return (L, e) => {
        ...
        return (
          d(),
          c("div", null, [
            o("p", S, "当前拥有的code列表：" + C(a(v)), 1),
            p(o("p", V, " *:*:* 代表拥有全部按钮级别权限 ", 512), [
              [E, ((y = a(v)) == null ? void 0 : y[0]) === "*:*:*"]
            ]),
            t(
              b,
              { shadow: "never", class: "mb-2" },
              {
                header: s(
                  () =>
                    e[0] ||
                    (e[0] = [
                      o("div", { class: "card-header" }, "组件方式判断权限", -1)
                    ])
                ),
                default: s(() => [
                  t(
              ...
              { shadow: "never", class: "mb-2" },
              {
                header: s(
                  () =>
                    e[4] ||
                    (e[4] = [
                      o("div", { class: "card-header" }, "函数方式判断权限", -1)
                    ])
                ),
                default: s(() => [
                  t(
