var E = (n, a, l) =>
  new Promise((d, h) => {
    var w = o => {
      ...
      v = o => (o.done ? d(o.value) : Promise.resolve(o.value).then(w, m));
...
/* empty css                     */ /* empty css                 */ import { u as z } from "./el-switch-L2aaNpdz.js";
import {
  g as t0,
  b as s0,
  a as i0,
...
const y = B({
    ...
    render() {
      const { delay: n } = this,
        a = H("motion");
      return A(I("div", {}, { default: () => [this.$slots.default()] }), [
        [
          a,
          {
...
const v0 = { render: m0 },
  _0 = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function g0(n, a) {
  return (
    u(),
    g(
...
const y0 = D({ name: "ri-lock-fill", render: g0 }),
  w0 = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function x0(n, a) {
  return (
    u(),
    g(
...
const M0 = D({ name: "ri-user-3-fill", render: x0 }),
  b0 = { class: "select-none" },
  V0 = ["src"],
  C0 = { class: "flex-c absolute right-5 top-3" },
  E0 = { class: "login-container" },
  $0 = { class: "img" },
  z0 = { class: "login-box" },
  B0 = { class: "login-form" },
  Z0 = { class: "outline-hidden" },
  D0 = B({
    name: "Login",
    __name: "index",
    setup(n) {
      const a = X(),
        ...
        { initStorage: w } = t0();
      w();
      const { dataTheme: m, overallStyle: v, dataThemeChange: o } = s0();
      o(v.value);
      const { title: _ } = i0(),
        f = Z({ username: "admin", password: "admin123" }),
        b = c =>
      ...
      return (
        ...
        (c, t) => {
          ...
          return (
            u(),
            g("div", b0, [
              i("img", { src: e(c0), class: "wave" }, null, 8, V0),
              i("div", C0, [
                s(
                  x,
                  {
              ...
              i("div", E0, [
                i("div", $0, [(u(), L(T(W(e(v0)))))]),
                i("div", z0, [
                  i("div", B0, [
                    s(e(p0), { class: "avatar" }),
                    s(e(y), null, {
                      default: r(() => [i("h2", Z0, G(e(_)), 1)]),
                      _: 1
                    }),
                    s(
                      k,
  ...
  N0 = l0(D0, [["__scopeId", "data-v-ebb74def"]]);
