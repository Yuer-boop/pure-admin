...
var V = U(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
  Ct = U(/Edge/i),
  ue = U(/firefox/i),
  wt = U(/safari/i) && !U(/chrome/i) && !U(/android/i),
  oe = U(/iP(ad|od|hone)/i),
  ve = U(/chrome/i) && U(/android/i),
...
function W(o, t, e, n) {
  if (o) {
    ...
    do {
      if (
        (t != null &&
          (t[0] === ">" ? o.parentNode === e && kt(o, t) : kt(o, t))) ||
        (n && o === e)
      )
        return o;
      if (o === e) break;
    ...
    if (
      (o !== window && o.parentNode && o !== L()
        ...
        : ((a = 0),
          ...
          (c = window.innerWidth)),
      (t || e) && o !== window && ((i = i || o.parentNode), !V))
    )
      do
        if (
          i &&
...
function ie(o, t) {
  for (
    ...
    e && (e === p.ghost || h(e, "display") === "none" || (t && !kt(e, t)));
    ...
    animateAll: function (n) {
      ...
      o.forEach(function (l) {
        var s = 0,
          ...
          E = l.rect,
          y = ct(u, !0);
        y && ((c.top -= y.f), (c.left -= y.e)),
          (u.toRect = c),
          u.thisAnimationDuration &&
            zt(b, c) &&
            !zt(d, c) &&
            (E.top - c.top) / (E.left - c.left) ===
              (d.top - c.top) / (d.left - c.left) &&
            (s = Ge(E, b, w, i.options)),
          zt(c, d) ||
            ((u.prevFromRect = d),
            (u.prevToRect = c),
  ...
  Ot = {
    ...
    pluginEvent: function (t, e, n) {
      ...
      lt.forEach(function (a) {
        e[a.pluginName] &&
          (e[a.pluginName][r] && e[a.pluginName][r](z({ sortable: e }, n)),
          e.options[a.pluginName] &&
            e[a.pluginName][t] &&
            e[a.pluginName][t](z({ sortable: e }, n)));
      });
    },
      ...
      return (
        lt.forEach(function (i) {
          typeof i.eventProperties == "function" &&
            q(n, i.eventProperties.call(e[i.pluginName], t));
        }),
        n
      );
    },
...
function Le(o) {
  var t = o.sortable,
    ...
    b = o.originalEvent,
    w = o.putSortable,
    E = o.extraEventProperties;
  if (((t = t || (e && e[N])), !!t)) {
    var y,
      k = t.options,
      j = "on" + n.charAt(0).toUpperCase() + n.substr(1);
    window.CustomEvent && !V && !Ct
      ? (y = new CustomEvent(n, { bubbles: !0, cancelable: !0 }))
      : ((y = document.createEvent("Event")), y.initEvent(n, !0, !0)),
      (y.to = a || e),
      (y.from = l || e),
      (y.item = i || e),
      (y.clone = r),
      ...
      z(
        {
          ...
          dispatchSortableEvent: function (l) {
            P({ sortable: e, name: l, originalEvent: i });
          }
        },
        r
      )
...
var f,
  ...
  Jt = !1,
  Wt = [],
  Lt = typeof document != "undefined",
  xt = oe,
  ge = Ct || V ? "cssFloat" : "float",
  je = Lt && !ve && !oe && "draggable" in document.createElement("div"),
  Te = (function () {
    if (Lt) {
      if (V) return !1;
...
function p(o, t) {
  ...
  var e = {
    ...
    supportPointer:
      p.supportPointer !== !1 && "PointerEvent" in window && (!wt || oe),
...
p.prototype = {
    ...
    if (t.cancelable) {
      ...
      if (
        ...
        !f &&
          ...
          ((s = W(s, i.draggable, n, !1)), !(s && s.animated) && Ft !== s))
      ) {
      ...
      if (
        ...
        (s = function () {
          ...
          i._disableDelayedDragEvents(),
            ...
            P({ sortable: i, name: "choose", originalEvent: t }),
            R(f, a.chosenClass, !0);
        }),
  ...
  _triggerDragStart: function (t, e) {
    (e = e || (t.pointerType == "touch" && t)),
      !this.nativeDraggable || e
        ...
        : (v(f, "dragend", this), v(_, "dragstart", this._onDragStart));
    try {
      document.selection
        ? Xt(function () {
  ...
  _dragStarted: function (t, e) {
    if (((ut = !1), _ && f)) {
      ...
      !t && R(f, n.dragClass, !1),
        ...
        (p.active = this),
        t && this._appendGhost(),
        P({ sortable: this, name: "start", originalEvent: e });
    } else this._nulling();
  },
  _emulateDragOver: function () {
    if (H) {
      ...
      for (
        ...
        t &&
        t.shadowRoot &&
        ((t = t.shadowRoot.elementFromPoint(H.clientX, H.clientY)), t !== e);
  ...
  _appendGhost: function () {
    if (!g) {
      var t = this.options.fallbackOnBody ? document.body : _,
        e = C(f, !0, xt, !0, t),
        n = this.options;
      if (xt) {
        for (
  ...
  _onDragStart: function (t, e) {
    ...
    x("setupClone", this),
      ...
      (n.cloneId = Xt(function () {
        x("clone", n),
          !p.eventCanceled &&
            (n.options.removeCloneOnHide || _.insertBefore(D, f),
            n._hideClone(),
            P({ sortable: n, name: "clone" }));
      })),
      !e && R(f, r.dragClass, !0),
      e
        ? ((Bt = !0), (n._loopId = setInterval(n._emulateDragOver, 50)))
        : (m(document, "mouseup", n._onDrop),
          m(document, "touchend", n._onDrop),
          m(document, "touchcancel", n._onDrop),
          i &&
            ((i.effectAllowed = "move"), r.setData && r.setData.call(n, i, f)),
          v(document, "drop", n),
      ...
      (bt = !0),
      window.getSelection().removeAllRanges(),
      wt && h(document.body, "user-select", "none");
  },
  _onDragOver: function (t) {
    ...
    function j() {
      k("dragOverAnimationCapture"),
        ...
        E !== b && b.captureAnimationState();
    }
    function A(vt) {
      return (
        k("dragOverCompleted", { insertion: vt }),
        vt &&
          (d ? u._hideClone() : u._showClone(E),
          E !== b &&
            (R(f, O ? O.options.ghostClass : u.options.ghostClass, !1),
            R(f, l.ghostClass, !0)),
          O !== E && E !== p.active
            ? (O = E)
            : E === p.active && O && (O = null),
          b === E && (E._ignoreWhileAnimating = n),
          E.animateAll(function () {
            k("dragOverAnimationComplete"), (E._ignoreWhileAnimating = null);
          }),
          E !== b && (b.animateAll(), (b._ignoreWhileAnimating = null))),
        ((n === f && !f.animated) || (n === e && !n.animated)) && (st = null),
        !l.dragoverBubble &&
          !t.rootEl &&
          n !== document &&
          (f.parentNode[N]._isOutsideThisEl(t.target), !vt && rt(t)),
    ...
    if (
      ...
      u &&
        ...
        (d
          ? c || (a = S !== _)
          : O === this ||
            ((this.lastPutMode = At.checkPull(this, u, f, t)) &&
              s.checkPut(this, u, f, t))))
    ) {
      if (
        ((w = this._getDirection(t, n) === "vertical"),
        (i = C(f)),
        k("dragOverValid"),
        p.eventCanceled)
      )
      ...
      if (a)
        return (
          ...
          this._hideClone(),
          k("revert"),
          p.eventCanceled || (at ? _.insertBefore(f, at) : _.appendChild(f)),
          A(!0)
        );
      ...
      if (!M || (Qe(t, w, this) && !M.animated)) {
        ...
        var G = 0,
          ...
          pt = w ? "top" : "left",
          K = ce(n, "top", "top") || ce(f, "top", "top"),
          gt = K ? K.scrollTop : void 0;
        st !== n &&
          ((nt = r[pt]), (Tt = !1), (Pt = (!F && l.invertSwap) || ht)),
          (G = Je(
            t,
            n,
            r,
        ...
        if (G !== 0) {
          var ot = Y(f);
          do (ot -= G), ($ = S.children[ot]);
          while ($ && (h($, "display") === "none" || $ === g));
        }
        if (G === 0 || $ === n) return A(!1);
        (st = n), (St = G);
        var mt = n.nextElementSibling,
          Z = !1;
        Z = G === 1;
        ...
        if (It !== !1)
          return (
            ...
            K && _e(K, 0, gt - K.scrollTop),
            (S = f.parentNode),
            nt !== void 0 && !Pt && (Rt = Math.abs(nt - C(n)[pt])),
            B(),
            A(!0)
          );
      }
      if (e.contains(f)) return A(!1);
    }
    return !1;
  },
  ...
  _onDrop: function (t) {
    ...
    (ut = !1),
      ...
      this.nativeDraggable &&
        (m(document, "drop", this), m(e, "dragstart", this._onDragStart)),
      this._offMoveEvents(),
      this._offUpEvents(),
      wt && h(document.body, "user-select", ""),
      h(f, "transform", ""),
      t &&
        (bt &&
          (t.cancelable && t.preventDefault(),
        ...
        f &&
          ...
          bt &&
            !ut &&
            R(f, O ? O.options.ghostClass : this.options.ghostClass, !1),
          ...
          _ !== S
            ? (X >= 0 &&
                ...
                P({ sortable: this, name: "sort", toEl: S, originalEvent: t })),
              O && O.save())
            : X !== ft &&
              X >= 0 &&
              (P({ sortable: this, name: "update", toEl: S, originalEvent: t }),
              P({ sortable: this, name: "sort", toEl: S, originalEvent: t })),
          p.active &&
            ((X == null || X === -1) && ((X = ft), (Q = Dt)),
            P({ sortable: this, name: "end", toEl: S, originalEvent: t }),
            this.save()))),
      this._nulling();
  },
  _nulling: function () {
  ...
  toArray: function () {
    for (
      ...
      (e = n[i]),
        W(e, a.draggable, this.el, !1) &&
          t.push(e.getAttribute(a.dataIdAttr) || en(e));
    return t;
  },
  sort: function (t, e) {
    var n = {},
  ...
  option: function (t, e) {
    ...
    typeof i != "undefined" ? (n[t] = i) : (n[t] = e), t === "group" && Oe(n);
  },
  destroy: function () {
    x("destroy", this);
    var t = this.el;
    (t[N] = null),
      ...
      this.nativeDraggable && (m(t, "dragover", this), m(t, "dragenter", this)),
  ...
  _showClone: function (t) {
    ...
    if (J) {
      ...
      f.parentNode == _ && !this.options.group.revertClone
        ? _.insertBefore(D, f)
        : at
          ? _.insertBefore(D, at)
          : _.appendChild(D),
        this.options.group.revertClone && this.animate(f, D),
        h(D, "display", ""),
        (J = !1);
    }
  }
...
function Ze(o, t, e) {
  var n = C(dt(e.el, 0, e.options, !0)),
    i = Se(e.el, e.options, g),
    r = 10;
  return t
...
function Qe(o, t, e) {
  var n = C(ie(e.el, e.options.draggable)),
    i = Se(e.el, e.options, g),
    r = 10;
  return t
...
function Je(o, t, e, n, i, r, a, l) {
  ...
  if (!a) {
    if (l && Rt < u * i) {
      if (
        (!Tt &&
          (St === 1 ? s > d + (u * r) / 2 : s < c - (u * r) / 2) &&
          (Tt = !0),
        Tt)
      )
        b = !0;
      else if (St === 1 ? s < d + Rt : s > c - Rt) return -St;
  ...
  return (
    (o.prototype = {
      ...
      _handleAutoScroll: function (e, n) {
        ...
        if (
          ((Gt = e), n || this.options.forceAutoScrollFallback || Ct || V || wt)
        ) {
    ...
    q(o, { pluginName: "scroll", initializeByDefault: !0 })
  );
}
function Yt() {
          ...
          ? ((et =
            ...
            (G =
              ...
              (F.overflowY === "auto" ||
                ...
                F.overflowY === "visible")))
          : ((et =
              B < nt && (F.overflowX === "auto" || F.overflowX === "scroll")),
            (G =
              M < ht && (F.overflowY === "auto" || F.overflowY === "scroll")));
        var gt =
            et &&
            (Math.abs(A - i) <= a && pt + B < nt) -
              (Math.abs(j - i) <= a && !!pt),
          $ =
            G &&
            (Math.abs(k - r) <= a && K + M < ht) -
              (Math.abs(y - r) <= a && !!K);
        if (!T[c]) for (var ot = 0; ot <= c; ot++) T[ot] || (T[ot] = {});
        (T[c].vx != gt || T[c].vy != $ || T[c].el !== w) &&
          ((T[c].el = w),
          (T[c].vx = gt),
          (T[c].vy = $),
          clearInterval(T[c].pid),
          (gt != 0 || $ != 0) &&
            ((u = !0),
            (T[c].pid = setInterval(
              function () {
                n && this.layer === 0 && p.active._onTouchMove(Gt);
                var mt = T[this.layer].vy ? T[this.layer].vy * l : 0,
